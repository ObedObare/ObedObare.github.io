...
public final class ActivityContactBinding implements ViewBinding {
  ...
  private ActivityContactBinding(@NonNull ScrollView rootView, @NonNull ImageButton backBtn,
      @NonNull Button callBtn) {
  ...
  public static ActivityContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityContactBinding((ScrollView) rootView, backBtn, callBtn);
    }
